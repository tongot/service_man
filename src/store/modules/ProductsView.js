...
const actions = {
    ...
    async getViewProducts({
        ...
        url = "/business_api/product/?page=" + page.number + "&search=" + actions.getsearch(page.search) + "&productCategory=" + searchArray.join() + // array of product ids
        "&sellers=" + page.businesses + // array of business ids selected (1,3,4)in form of a string
